package client.front.navigation;
 ...
 * a client.back button clicked. The objects in the <code>LinkedList</code> show the scene switching flow.
 * How to use :
 * - To go forward to another scene : yourScene.setScene(Flow.forward(yourNewScene));
 * - To go client.back to the previous scene : yourScene.setScene(Flow.client.back());
 */
public class Flow {
