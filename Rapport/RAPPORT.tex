...
\subfile{subfiles/Interaction Overview Intro & Auth.tex}
...
\hspace{-1cm}
\hbox{
	\includegraphics[scale=0.55]{img/Use Case Institution - Extension 6.pdf}
}
\end{figure}
...
\hspace{-3cm}
\hbox{
	\includegraphics[scale=0.5]{img/Interaction Overview Institution - Extension 6.pdf}
}
\end{figure}
