...
public class SignUpSceneController extends Controller implements BackButtonNavigator, LanguageButtonNavigator {
    ...
    public void initialize() {
        ...
        // TODO : client.back-end : fetch all available languages and put them in the list
    ...
    public void signUp() {
        ...
        if (noLabelVisible()) {
            ...
            // TODO : client.back-end : user creation implementation
            userSignedUp = true;
    ...
    private boolean isUsernameTaken(String username) {
        // TODO : client.back-end : implement this method
        return false;
    }
