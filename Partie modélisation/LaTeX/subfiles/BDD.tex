Tout d'abord, certaines parties de ce modèle de données sont présentes car toutes les application (commune + extension) se basent sur le même modèle de données. L'application de base à donc été
